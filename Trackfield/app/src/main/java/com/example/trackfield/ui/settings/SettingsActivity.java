package com.example.trackfield.ui.settings;
...
import com.example.trackfield.view.dialogs.RadioDialog;
import com.example.trackfield.view.dialogs.TextDialog;
...
public class SettingsActivity extends AppCompatActivity implements RadioDialog.DialogListener,
    ...
    public void onBinaryDialogPositiveClick(String passValue, String tag) {
        if (tag.equals(DIALOG_EXPORT)) {
            ...
            new Thread(() -> {
                boolean success = FileManager.exportJson(this);
                runOnUiThread(() -> {
            ...
            new Thread(() -> {
                boolean success = FileManager.importJson(this);
                runOnUiThread(() -> {
