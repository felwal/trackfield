...
public class RouteDetailAdapterDelegate extends
    BaseAdapterDelegate<Exerlite, RecyclerItem, RouteDetailAdapterDelegate.ExerciseSmallViewHolder> {
    ...
    public RouteDetailAdapterDelegate(Activity a, DelegateClickListener listener, BaseListAdapter adapter,
        int originId) {
