...
public class IntervalDetailExerciseAdapterDelegate extends
    BaseAdapterDelegate<Exerlite, RecyclerItem, IntervalDetailExerciseAdapterDelegate.ExerciseMediumViewHolder> {
    ...
    public IntervalDetailExerciseAdapterDelegate(Activity a, DelegateClickListener listener, BaseAdapter adapter,
        int originId) {
