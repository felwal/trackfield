...
public class IntervalDetailAdapterDelegate extends
    BaseAdapterDelegate<Exerlite, RecyclerItem, IntervalDetailAdapterDelegate.ExerciseMediumViewHolder> {
    ...
    public IntervalDetailAdapterDelegate(Activity a, DelegateClickListener listener, BaseListAdapter adapter,
        int originId) {
