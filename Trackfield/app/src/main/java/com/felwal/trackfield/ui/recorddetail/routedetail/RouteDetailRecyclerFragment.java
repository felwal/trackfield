...
public class RouteDetailRecyclerFragment extends RecyclerFragment {
    ...
    public static RouteDetailRecyclerFragment newInstance(int routeId, int originId) {
        RouteDetailRecyclerFragment instance = new RouteDetailRecyclerFragment();
    ...
    protected BaseAdapter getAdapter() {
        return new RouteDetailAdapter(a, this, items, originId);
    }
