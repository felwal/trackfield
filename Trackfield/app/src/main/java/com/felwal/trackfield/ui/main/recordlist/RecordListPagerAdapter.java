...
public class RecordListPagerAdapter extends FragmentPagerAdapter {
    ...
    public RecordListPagerAdapter(ViewPager viewPager, TabLayout tabLayout, Context c, FragmentManager fm) {
        super(fm);
        this.c = c;
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case POS_INTERVALS: return (intervalsFragment = new IntervalListRecyclerFragment());
            case POS_ROUTES: return (routesFragment = new RouteListRecyclerFragment());
            case POS_DISTANCES:
            default: return (distancesFragment = new DistanceListRecyclerFragment());
        }
    }
